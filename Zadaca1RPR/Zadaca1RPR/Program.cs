...
namespace Zadaca1RPR
{
    ...
    {       
        ...
        static void Main(string[] args)
        {
            ...
            Patient patient17336_2 = new UrgentPatient("Prva pomoc je uspjesna.", false, "Elvir", "Crncevic", new DateTime(1996, 8, 17), "1708199612345", "Dobrinja 4568", false, DateTime.Today, male, new List<string> { "L", "R", "H" }, "ecrncevic", "elvir", Image.FromFile(@"elvir.jpg"), "Nema", healthbook17336_1);
